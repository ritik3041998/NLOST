...
def get_args_parser():
    ...
    parser.add_argument("--model_name", type=str, default="nlost")  
    parser.add_argument("--model_dir", type=str, default=None)
    parser.add_argument("--data_dir", type=str, default="/data/yueli/dataset/bike")
    parser.add_argument("--nlost_datapath", type=str, default=None)
    parser.add_argument("--fk_datapath", type=str, default=None)
    ...
    # set dataset / measurement geometry params (defaults reproduce the Bike setup)
    parser.add_argument("--dataset", type=str, default="bike", help="dataset name (informational: bike | bunny)")
    parser.add_argument("--meas_size", type=int, default=256, help="raw measurement spatial size fed to the loader (Bike:256, Bunny:64)")
    parser.add_argument("--ds", type=int, default=1, help="temporal binning factor in the loader (Bike:1, Bunny:4 -> 2048/4=512)")
    parser.add_argument("--clip", type=int, default=512, help="number of temporal bins kept after binning")
    # set model geometry params (must be consistent with the measurement geometry above)
    parser.add_argument("--model_spatial", type=int, default=64, help="model spatial grid = measurement/2 (Bike:64, Bunny:32)")
    parser.add_argument("--tlen", type=int, default=256, help="FK crop / temporal length (power of 2; = clip/2)")
    parser.add_argument("--bin_len", type=float, default=0.01, help="temporal bin length for the FK reconstruction")
    # set model params
    ...
    parser.add_argument("--num_save", type=int, default=44) 
